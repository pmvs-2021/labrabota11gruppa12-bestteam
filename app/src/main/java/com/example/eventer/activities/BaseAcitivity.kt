package com.example.eventer.activities
...
import com.example.eventerproject.activities.ui.events.notifyService.MyService
...
class BaseAcitivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Log.println(Log.INFO, "BASE", "STARTING SERVICE")

        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O && !isMyServiceRunning(MyService::class.java)) {
            val channelId =
        ...
        appBarConfiguration = AppBarConfiguration(
            setOf(
                R.id.nav_home, R.id.nav_map, R.id.nav_events, R.id.nav_eventer_favorite
            ), drawerLayout
        )
...
//        navController.graph.startDestination=R.id.nav_events;
    ...
    override fun onCreateOptionsMenu(menu: Menu): Boolean {
        ...
        menuInflater.inflate(R.menu.base_acitivity, menu)
        return true
    }
